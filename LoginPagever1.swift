        ...
        ZStack {
            ...
            VStack {
                ...
                Button("Sign in") {
                    ...
                    print("Sign in tapped, navigating to Moodtracker")
                }
                .frame(width: 300, height: 50)
            ...
            // navigationDestination should be on the NavigationStack at the root,
            // or on a common parent of the views that navigate.
            // Keeping it here for direct pushes from this view.
            .navigationDestination(for: String.self) { viewID in
                if viewID == "CreateAccountView" {
                    CreateAccountView()
                } else if viewID == "Moodtracker" {
                    moodTracker()
